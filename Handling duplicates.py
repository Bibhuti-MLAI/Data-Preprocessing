...
retail = pd.read_csv("E:\\360digiTMG assignment\\Data Science\\Data praprocessing\\OnlineRetail.csv",header= 0, encoding= 'unicode_escape')
retail =retail.iloc[0:10000,:]
